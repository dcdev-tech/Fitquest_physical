...
# Source: ages_14-18/long_jump/long_jump.ipynb
...
def long_jump(ID="DCXXXX", name="Life", path=0, data_print='Y', jumped_length = 60):
    ...
    if (data_print =='Y' or data_print == 'y'):
        ...
        print(f"Technique – legs:--> knee_lift_final: {knee_lift_final*frame_height}")
        print(f"Technique – ankle:--> ankle_diff_final: {ankle_diff_final*frame_height}")
